...
//update blog post
Route::put('/blog/{post}', [BlogController::class, 'update'])->name('blog.update')->middleware('auth');

//update blog post
Route::delete('/blog/{post}', [BlogController::class, 'delete'])->name('blog.delete')->middleware('auth');
